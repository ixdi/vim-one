...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  if &background ==# 'dark'
    let s:dark = 1
    let s:mono_1 = ['#eeeeee', '145']
    let s:mono_2 = ['#cccccc', '102']
    let s:mono_3 = ['#aaaaaa', '59']
    let s:mono_4 = ['#929191', '59']

    let s:hue_1  = ['#ffc594', '73'] " cyan
    " let s:hue_2  = ['#89e8f5', '75'] " blue
    let s:hue_2  = ['#bbf4fc', '75'] " blue
    let s:hue_3  = ['#dfa6ef', '176'] " purple
    let s:hue_4  = ['#84e3b5', '114'] " green

    let s:hue_5   = ['#f99ea5', '168'] " red 1
    let s:hue_5_2 = ['#e78179', '130'] " red 2

    let s:hue_6   = ['#d19a66', '173'] " orange 1
    let s:hue_6_2 = ['#ffe3b0', '180'] " orange 2

    let s:syntax_bg     = ['#282828', '16']
    let s:syntax_gutter = ['#636d83', '60']
    let s:syntax_cursor = ['#444444', '16']

    let s:syntax_accent = ['#79a6ff', '69']

    let s:vertsplit    = ['#555555', '233']
    let s:special_grey = ['#666666', '16']
    let s:visual_grey  = ['#777777', '17']
    let s:pmenu        = ['#555555', '16']
  endif
